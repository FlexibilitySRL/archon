...
export interface BuilderToolbarProps {
  ...
  provider: 'claude' | 'codex' | 'copilot' | undefined;
  ...
  onProviderChange: (p: 'claude' | 'codex' | 'copilot' | undefined) => void;
      ...
      <div className="flex items-center h-12 px-3 border-b border-border gap-2">
        ...
        <div className="flex items-center gap-1.5 mx-auto">
          <select
            ...
            onChange={(e): void => {
              onProviderChange(
                (e.target.value || undefined) as 'claude' | 'codex' | 'copilot' | undefined
              );
            }}
